...
class GUI(Tk):
    ...
    def with_selecting_dataset_or_modus(self, event):
        ...
        if len(compared_date_range) > 1: least_valid_year = self.get_least_valid_year(compared_date_range_=compared_date_range)
...
def main_func():
    root = GUI()
    root.title('Wetterderivate und Klima v_b0.2.5')
