...
class GUI(Tk):
    ...
    def set_up_dataset_menu(self):
        ...
        self.dataset_menu_drop_down.bind("<<ComboboxSelected>>", self.with_selecting_dataset)
    ...
    def set_up_modus_menu(self):
        ...
        self.modus_menu_value_drop_down.bind("<<ComboboxSelected>>", self.with_selecting_modus)
    ...
    def with_selecting_dataset(self, event):
        self.start_thread(task=self.with_selecting_dataset_action(), task_name='text_update')
...
def main_func():
    root = GUI()
    root.title('Wetterderivate und Klima v_b0.8.3')
